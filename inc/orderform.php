...
?>
	<form id="orderForm" name="orderForm" action="<?php echo BASE_URL; ?>api/1/order/">
    			<fieldset>
    				<p>
		    			<label for="customer-name">Name:</label>
		    			<input type="text" id="customer-name" name="customer-name" placeholder="E.g. Andy Murray" required />
	    			</p>
	    			<p>
		    			<label for="customer-address">Address:</label>
		    			<textarea id="customer-address" name="customer-address" placeholder="E.g. University House, Winston Churchill Ave, Portsmouth PO1 2UP" required></textarea>
	    			</p>
	    			<p>
		    			<label for="customer-country">Country:</label>
		    			<!-- Thanks http://www.dzone.com/snippets/html-select-list-countries ! -->
